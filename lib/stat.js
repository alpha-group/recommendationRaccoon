    ...
    return new Promise((resolve, reject) => {
      ...
      */
      ...
      .then(() => {
         ...
         */
        return client.zcount(Key.userFilteredActiveItemsZSet(userId), 0, '+inf');
      })
      .then(activeCount => {
          ...
          case (activeItemsCount[1] > 0 && recommendedItemCount[1] > 0):
            ...
            return client.zinterstore(
              ...
              Key.activeItemsZSet()).then(() => {
                 ...
                 */
                console.log('#### Intersection is empty, falling back to recommended items set')
          ...
          case (activeItemsCount[1] > 0):
            ...
            return client.zunionstore(
              ...
              'MAX'
                ...
                filteredZSetCreated = true;
                return client.zrevrangebyscore(Key.userFilteredActiveItemsZSet(userId), '+inf', 0).then(results => {
      ...
      .then(results => {
        ...
        if (filteredZSetCreated) {
          return client.expire(Key.userFilteredActiveItemsZSet(userId), 300).then(() => {
            resolve(results);
          });
        } else {
          resolve(results);
