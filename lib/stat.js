...
const filteredActiveItems = function (userId) {
    ...
    return new Promise((resolve, reject) => {
      ...
      */
      ...
      .then(() => {
        ...
        return filteredActiveItems(userId);
      })
      .then(() => {
         ...
         */
        return client.zcount(Key.userFilteredActiveItemsZSet(userId), 1, '+inf');
      })
      .then(activeCount => {
          ...
          case (activeItemsCount[1] > 0 && recommendedItemCount[1] > 0):
            ...
            return client.zinterstore(
              ...
              Key.activeItemsZSet()).then(() => {
                ...
                return filteredActiveItems(userId).then(() => {
                  filteredZSetCreated = true;
